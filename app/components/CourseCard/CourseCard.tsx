...
export const CourseCard = ({ course }: { course: CourseData }) => {
	...
	return <Link href={`/courses/${course.id}`}
	             className="group block bg-white border border-zinc-100 rounded-[1.5em] overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
		<figure className="relative h-[15em] overflow-hidden">
