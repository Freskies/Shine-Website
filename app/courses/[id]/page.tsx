			...
			<div className="max-w-[60rem] mx-auto px-[1em] mb-[4em]">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-[4em] items-start">
					<div className="flex flex-col h-full">
						<h1 className="text-[3.5em] font-bold mb-[0.5em]">{title}</h1>
					...
					<div className="bg-zinc-50 p-[2em] rounded-[2em] border border-zinc-100 flex flex-col self-stretch">
						<h2 className="text-[1.5em] font-bold mb-[1em]">The Coach</h2>
						<div className="flex items-center gap-[1em] mb-[1.5em]">
							<div className="w-[4em] h-[4em] bg-zinc-200 rounded-full overflow-hidden relative border-2 border-white shadow-sm">
						...
						<p className="text-zinc-600 text-[0.9em] mb-[1.5em] flex-grow">
							Coach {course.instructor} is an experienced parkour practitioner.
						</p>
