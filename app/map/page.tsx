	...
	return <div className="flex flex-col min-h-screen">
		...
		<main className="pt-[6em] pb-[4em] px-[1em]">
			<div className="max-w-[80rem] mx-auto">
				...
				<div
					className="bg-zinc-100 rounded-[2em] h-[40em] flex items-center justify-center border-2 border-dashed border-zinc-300">
					<p className="text-zinc-500 text-[1.2em]">Coming Soon</p>
				</div>
			</div>
		</main>
		<Footer/>
